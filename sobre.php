...
<head>
<?php
    $head_title = "Sobre a Mirror Fashion";
    $css = "<link rel=\"stylesheet\" href=\"/css/sobre.css\">";
    include("head.php");
?>
...
<body>
    ...
    <div id="first-text">
        <!-- ID utilizado para testar o alinhamento a direita da imagem "centro-distribuiçao.png", colocando
        o float da tag <figure id="centro-distribuicao"> com float:right (no CSS) -->
    ...
    <figure id="centro-distribuicao">
        <!-- Tag de marcação de imagem, vinculando, através das Tags filhas, uma imagem a uma legenda-->
        <img src="img/centro-distribuicao.png" alt="Visão panorâmica da Sede Mirror Fashion">
        <!-- Tag indicando o contéudo da imagem a ser inserida-->
        <figcaption>Centro de Distribuição da <strong>Mirror Fashion</strong></figcaption>
        <!-- Legenda da imagem exibida pela "Tag-irmã" (mesmo nível hierárquico) 
                                                                                               <img src...> -->
    </figure>
    <!-- Fim do conteúdo da Tag figure -->
    ...
    <p> A sua fundação, há <?php print date("Y") ?> anos, ocorreu no momento da descoberta econônica do interior do Paraná. A família Pelho, tradicional da região, investiu todas as suas economias nessa nova iniciativa, revolucionária para a época. O fundador Eduardo Simões Pelho, dotado
        de particular visão administrativa, guiou os negócios da empresa durante mais de 50 anos, muitos deles ao lado de seu filho E. S. Pelho Filho, atual CEO. O nome da empresa é inspirado no nome da família.</p>
    ...
    <p>Dada a importância econômica da empresa para o Brasil, a família Pelho já recebeu diversos prêmios, homenagens e condecorações. Todos os presidentes do Brasil já visitaram as instalações da Mirror Fashion, além de presidentes da União Européia, Ásia
    ...
    <!--div id="rodape">
        <img src="img/logo.png"> &copy; Copyright Mirror Fashion
    </div-->
</body>
